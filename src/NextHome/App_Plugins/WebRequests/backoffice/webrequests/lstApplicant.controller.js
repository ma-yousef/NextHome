angular.module('umbraco')
    .controller('lstApplicantController', function ($scope, apiHelper, notificationsService, dialogService) {

        $scope.filesUrl = Umbraco.Sys.ServerVariables.DomainUrl+'/Uploads/';
        $scope.selectedIds = [];
        ...
        function fetchData() {
            apiHelper.getPagedApplicants($scope.itemsPerPage, $scope.currentPage, $scope.predicate, $scope.reverse ? "desc" : "asc", $scope.searchTerm).then(function (response) {
